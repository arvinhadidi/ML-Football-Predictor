...
def process_data(filename, predictions, first_year, second_year):
    ...
    # Filter the DataFrame to include only the dates between 01/08/2018 and 01/08/2019
    ...
    for _, row in df.iterrows():
        ...
        # Check if the team name has not been stored in a variable yet (unique)
...
if __name__ == "__main__":
    ...
    print("Team Points Based on Actual Results:")
